...
public class SearchUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allUsersList = (RecyclerView)findViewById(R.id.search_users_list);
        ...
        SearchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(SearchUsersActivity.this,"Please write a user name to search...",Toast.LENGTH_SHORT);
    ...
    private void SearchForPeopleAndFriends(String searchUserName) {
        ...
        Query searchPeopleAndFriends = allDatebaseUserreference.orderByChild("user_name")
            ...
            protected void populateViewHolder(AllUsersViewHolder viewHolder, AllUsers model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent profileIntent = new Intent(SearchUsersActivity.this,ProfileActivity.class);
